...
namespace CuriousDriveWebAPI.CuriousDrive
{
    public class Constant
    {
        ...
        //Roles
        public static String RoleGeneral = "General";
        public static String RoleStudent = "Students";
        public static String RoleModerator = "Moderators";
        public static String RoleTeacher = "Teachers";
        public static String RoleAdmin = "Admins";
