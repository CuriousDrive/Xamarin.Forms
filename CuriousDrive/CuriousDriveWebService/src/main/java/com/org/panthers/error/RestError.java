 ...
 */
package com.org.panthers.error;

import java.util.LinkedHashMap;
import java.util.Map;

import com.org.panthers.http.HttpStatus;
import com.org.panthers.lang.ObjectUtils;
...
public class RestError {
	...
	@Override
	public int hashCode() {
		return ObjectUtils.nullSafeHashCode(getStatus(), getCode(),
				getMessage(), getDeveloperMessage(), getMoreInfoUrl(),
				getThrowable());
	}

	public String toString() {
		return append(new StringBuilder(), getStatus()).append(", message: ")
				.append(getMessage()).toString();
	}

	private StringBuilder append(StringBuilder buf, HttpStatus status) {
		buf.append(status.value()).append(" (")
