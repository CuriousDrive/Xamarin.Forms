...
INNER JOIN TRAN_POST_VOTE TPV ON TPV.SUBSYSTEM_REFERENCE_ID = TQ.QUESTION_ID
...
FROM TRAN_QUESTION_ANSWER TQA 
LEFT OUTER JOIN TRAN_POST_VOTE TPV ON TPV.SUBSYSTEM_REFERENCE_ID = TQA.QUESTION_ID
...
INSERT INTO POINTS_RANKED
SELECT 0 AS TOTAL_POINTS,USER_ID FROM SYS_USER 
...
INNER JOIN SYS_USER SU ON SU.USER_ID = UR.USER_ID
WHERE UR.USER_ID = ?;
